...
(94, 1, 4, 0, 'member', 4, 'szq在2016-05-08 15:35登录了后台', 1, 1462692921),
(85, 1, 1, 0, 'member', 1, 'admin在2016-05-08 13:47登录了后台', 1, 1462686446),
(86, 1, 4, 0, 'member', 4, 'szq在2016-05-08 14:05登录了后台', 1, 1462687509),
(87, 1, 1, 0, 'member', 1, 'admin在2016-05-08 14:06登录了后台', 1, 1462687581),
(88, 1, 2, 0, 'member', 2, 'swc在2016-05-08 14:29登录了后台', 1, 1462688957),
(89, 1, 2, 0, 'member', 2, 'swc在2016-05-08 15:14登录了后台', 1, 1462691652),
(93, 1, 2, 0, 'member', 2, 'swc在2016-05-08 15:31登录了后台', 1, 1462692676),
(92, 1, 1, 0, 'member', 1, 'admin在2016-05-08 15:27登录了后台', 1, 1462692429),
(95, 1, 1, 0, 'member', 1, 'admin在2016-05-08 15:36登录了后台', 1, 1462692983),
(96, 1, 1, 0, 'member', 1, 'admin在2016-05-08 15:37登录了后台', 1, 1462693061),
(97, 1, 5, 0, 'member', 5, 'qxx在2016-05-08 15:40登录了后台', 1, 1462693218),
(98, 1, 1, 0, 'member', 1, 'admin在2016-05-08 15:45登录了后台', 1, 1462693528),
(99, 1, 1, 0, 'member', 1, 'admin在2016-05-09 13:57登录了后台', 1, 1462773474),
(100, 1, 1, 0, 'member', 1, 'admin在2016-05-09 21:03登录了后台', 1, 1462798998),
(101, 1, 1, 0, 'member', 1, 'admin在2016-05-09 22:35登录了后台', 1, 1462804552),
(102, 1, 1, 0, 'member', 1, 'admin在2016-05-09 23:09登录了后台', 1, 1462806560),
(103, 1, 1, 0, 'member', 1, 'admin在2016-05-09 23:38登录了后台', 1, 1462808305),
(104, 1, 1, 0, 'member', 1, 'admin在2016-05-10 00:00登录了后台', 1, 1462809634),
(105, 1, 1, 0, 'member', 1, 'admin在2016-05-10 15:43登录了后台', 1, 1462866239),
(106, 1, 1, 0, 'member', 1, 'admin在2016-05-10 16:11登录了后台', 1, 1462867899),
(107, 1, 1, 0, 'member', 1, 'admin在2016-05-10 19:25登录了后台', 1, 1462879527),
(108, 1, 1, 0, 'member', 1, 'admin在2016-05-10 20:36登录了后台', 1, 1462883788),
(109, 1, 1, 0, 'member', 1, 'admin在2016-05-11 10:42登录了后台', 1, 1462934534),
(110, 1, 4, 0, 'member', 4, 'szq在2016-05-11 10:43登录了后台', 1, 1462934591),
(111, 1, 1, 0, 'member', 1, 'admin在2016-05-11 10:46登录了后台', 1, 1462934779),
(112, 1, 2, 0, 'member', 2, 'swc在2016-05-11 11:36登录了后台', 1, 1462937798),
(113, 1, 1, 0, 'member', 1, 'admin在2016-05-11 11:48登录了后台', 1, 1462938530),
(114, 1, 1, 0, 'member', 1, 'admin在2016-05-18 13:43登录了后台', 1, 1463550207),
(115, 1, 1, 0, 'member', 1, 'admin在2016-05-29 17:29登录了后台', 1, 1464514150),
(116, 1, 1, 0, 'member', 1, 'admin在2016-05-29 17:30登录了后台', 1, 1464514240),
(117, 1, 1, 0, 'member', 1, 'admin在2016-05-30 09:35登录了后台', 1, 1464572129),
(118, 1, 1, 0, 'member', 1, 'admin在2016-05-30 11:28登录了后台', 1, 1464578910),
(119, 1, 1, 0, 'member', 1, 'admin在2016-05-31 14:07登录了后台', 1, 1464674845),
(120, 1, 1, 0, 'member', 1, 'admin在2016-05-31 23:44登录了后台', 1, 1464709488),
(121, 1, 1, 0, 'member', 1, 'admin在2016-06-03 10:29登录了后台', 1, 1464920984),
(122, 1, 1, 0, 'member', 1, 'admin在2016-06-03 17:52登录了后台', 1, 1464947534),
(123, 1, 2, 0, 'member', 2, 'swc在2016-06-03 18:49登录了后台', 1, 1464950973),
(124, 1, 1, 0, 'member', 1, 'admin在2016-06-03 18:49登录了后台', 1, 1464950988),
(125, 1, 1, 0, 'member', 1, 'admin在2016-06-04 08:41登录了后台', 1, 1465000895);
...
('9787302423287', 0000000047, '杭电图书馆', 1),
('9787302423287', 0000000048, '杭电图书馆', 0);

--
-- Triggers `ot_bookid_isbn`
--
DROP TRIGGER IF EXISTS `update_remainnum_afterupdate`;
DELIMITER //
CREATE TRIGGER `update_remainnum_afterupdate` AFTER UPDATE ON `ot_bookid_isbn`
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `update_totalnum_afterdelete`;
DELIMITER //
CREATE TRIGGER `update_totalnum_afterdelete` AFTER DELETE ON `ot_bookid_isbn`
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `update_totalnum_afterinsert`;
DELIMITER //
CREATE TRIGGER `update_totalnum_afterinsert` AFTER INSERT ON `ot_bookid_isbn`
...
(1, '9787115392602', 0000000005, 1464676276, 1467268276, 'Swift基础教程'),
(3, '9787302423287', 0000000048, 1462687560, 1465279560, '机器学习');

--
-- Triggers `ot_borrow`
--
DROP TRIGGER IF EXISTS `update_reader_afterdelete`;
DELIMITER //
CREATE TRIGGER `update_reader_afterdelete` AFTER DELETE ON `ot_borrow`
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `update_reader_afterinsert`;
DELIMITER //
CREATE TRIGGER `update_reader_afterinsert` AFTER INSERT ON `ot_borrow`
...
--
-- Dumping data for table `ot_borrow_history`
--

INSERT INTO `ot_borrow_history` (`book_name`, `user_id`, `borrow_time`, `return_time`, `book_id`, `ISBN`) VALUES
('Swift语言实战入门（第2版）', 1, 1462866253, 1462866257, 0000000001, '9787115308276'),
('Swift语言实战入门（第2版）', 1, 1464676329, 1464676337, 0000000001, '9787115308276'),
('Swift语言实战入门（第2版）', 1, 1464947558, 1464947565, 0000000001, '9787115308276'),
('Swift语言实战入门（第2版）', 1, 1465008575, 1465008595, 0000000001, '9787115308276'),
('Swift与Cocoa框架开发', 1, 1462800034, 1462800037, 0000000003, '9787115391872'),
('Swift与Cocoa框架开发', 1, 1462800389, 1462804764, 0000000003, '9787115391872'),
('Swift与Cocoa框架开发', 1, 1462804773, 1462805084, 0000000003, '9787115391872'),
('Swift基础教程', 1, 1462683536, 1462688318, 0000000005, '9787115392602'),
('Swift基础教程', 1, 1462688477, 1462688499, 0000000005, '9787115392602'),
('Swift基础教程', 1, 1462868127, 1462879557, 0000000005, '9787115392602'),
('机器学习', 1, 1462684841, 1462688540, 0000000047, '9787302423287'),
('机器学习', 1, 1462688642, 1462688715, 0000000047, '9787302423287'),
('机器学习', 1, 1462688806, 1462688835, 0000000047, '9787302423287'),
('机器学习', 1, 1462688844, 1462688846, 0000000047, '9787302423287'),
('机器学习', 1, 1462688860, 1465008612, 0000000047, '9787302423287'),
('Swift基础教程', 2, 1462688995, 1462688999, 0000000005, '9787115392602'),
('Swift基础教程', 2, 1462689026, 1462689030, 0000000005, '9787115392602');

--
-- Triggers `ot_borrow_history`
--
DROP TRIGGER IF EXISTS `update_total_afterinsert`;
DELIMITER //
CREATE TRIGGER `update_total_afterinsert` AFTER INSERT ON `ot_borrow_history`
...
(1, 'admin', 0, '0000-00-00', '', 100, 59, 0, 1460863718, 0, 1465000895, 1),
(2, 'swc', 0, '0000-00-00', '', 40, 8, 0, 1460986400, 0, 1464950973, 1),
(4, 'szq', 0, '0000-00-00', '', 20, 4, 0, 1462687509, 0, 1462934591, 1),
(5, 'qxx', 0, '0000-00-00', '', 10, 2, 0, 1462692921, 0, 1462693218, 1);
...
DELIMITER //
CREATE TRIGGER `test` AFTER INSERT ON `ot_member`
 FOR EACH ROW insert into ot_reader (user_id) values(new.uid)
//
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `ot_reader` (
  ...
  `current_borrow` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '当前借阅',
  `total_borrow` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '累计借阅',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, '15957190991', 1, '计算机', '计算机科学与技术', '沈伟臣', 1, 15),
(2, '15957191396', 0, '计算机', '计算机科学与技术', '滕越', 0, 2),
(4, '13777888274', 1, '计算机', '计算机科学与技术', '盛竹青', 1, 0),
(5, '214214', 1, '计算机', '网络工程', '覃幸新', 0, 0);
...
(1, 'admin', 'ab51f9d10187832ceb782655beae0eb3', '519589356@qq.com', '', 1460863718, 0, 1465000895, 0, 1460863718, 1),
(2, 'swc', '7c315f84bad9c7faf8f4120224ecf36d', 'last.fantasy@qq.com', '', 1460986386, 0, 1464950973, 0, 1460986386, 1),
(4, 'szq', 'b4f64f39e300d5cafa9cf90944fc4f0f', 'szq@qq.com', '', 1462687501, 0, 1462934591, 0, 1462687501, 1),
(5, 'qxx', '197fbca7cc3f38499feb99d9293de849', 'qxx@qq.com', '', 1462692902, 0, 1462693218, 0, 1462692902, 1);
